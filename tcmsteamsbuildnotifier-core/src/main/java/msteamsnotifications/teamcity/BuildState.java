...
public class BuildState {
    ...
    /**
     * Takes the currentBuildState, for which the MsTeamsNotification is being triggered
     * and compares it against the build states for which this MsTeamsNotification is configured
     * to notify.
     * 
     * @param currentBuildState
     * @param buildStatesToNotify
     * @return Whether or not the msteamsnotifications should trigger for the current build state.
     */
