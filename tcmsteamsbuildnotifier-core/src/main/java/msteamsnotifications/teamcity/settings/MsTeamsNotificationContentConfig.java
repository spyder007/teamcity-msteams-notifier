...
public class MsTeamsNotificationContentConfig {
    ...
    private String iconUrl = MsTeamsNotificationMainConfig.DEFAULT_ICONURL;
    private String botName = MsTeamsNotificationMainConfig.DEFAULT_BOTNAME;
