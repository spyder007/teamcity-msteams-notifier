...
public class MsTeamsNotificationProxyConfig {
	...
	public MsTeamsNotificationProxyConfig(String hostname, Integer port, String username, String password) {
	...
	public MsTeamsNotificationProxyConfig(String hostname, Integer port) {
		this.proxyHost = hostname;
		this.proxyPort = port;
	}
