...
public class MsTeamsNotificationTestProxyServer {
	Server server;

	public MsTeamsNotificationTestProxyServer(String host, Integer port) {
		server = new Server(port);
		Context root = new Context(server,"/",Context.SESSIONS);
		root.addServlet(new ServletHolder(new ProxyServerServlet()), "/*");
	}
	
	public MsTeamsNotificationTestProxyServer(String host, Integer port, String proxyUsername, String proxyPassword) {
		server = new Server(port);
		Context root = new Context(server,"/",Context.SESSIONS);
